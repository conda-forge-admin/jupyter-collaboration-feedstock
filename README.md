...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyter-collaboration-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyter-collaboration-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyter-collaboration
# for installing globally
pixi global install jupyter-collaboration
```
...
It is possible to list all of the versions of `jupyter-collaboration` available on your platform:
...
```
pixi search jupyter-collaboration --channel conda-forge
```
